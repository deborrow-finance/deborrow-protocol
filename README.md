[![CircleCI](https://circleci.com/gh/deborrow-finance/deborrow-protocol.svg?style=svg&circle-token=5ed19932325c559a06f71f87d69012aedd2cf3fb)](https://circleci.com/gh/deborrow-finance/deborrow-protocol) [![codecov](https://codecov.io/gh/deborrow-finance/deborrow-protocol/branch/master/graph/badge.svg?token=q4UvsvVzOX)](https://codecov.io/gh/deborrow-finance/deborrow-protocol)
...
* The [DeBorrow Whitepaper](https://github.com/deborrow-finance/deborrow-protocol/tree/master/docs/DeBorrowWhitepaper.pdf), describing how DeBorrow works
* The [DeBorrow Protocol Specification](https://github.com/deborrow-finance/deborrow-protocol/tree/master/docs/DeBorrowProtocol.pdf), explaining in plain English how the protocol operates

For questions about interacting with DeBorrow, please visit [our Discord server](https://deborrow.finance/discord).

For security concerns, please visit [https://deborrow.finance/security](https://deborrow.finance/security) or email [security@deborrow.finance](mailto:security@deborrow.finance).
...
<dl>
  ...
  <dd>The DeBorrow cTokens, which are self-contained borrowing and lending contracts. CToken contains the core logic and CErc20 and CEther add public interfaces for Erc20 tokens and ether, respectively. Each CToken is assigned an interest rate and risk model (see InterestRateModel and Comptroller sections), and allows accounts to *mint* (supply capital), *redeem* (withdraw capital), *borrow* and *repay a borrow*. Each CToken is an ERC-20 compliant token where balances represent ownership of the market.</dd>
</dl>
...
<dl>
  <dt>DEBO</dt>
  <dd>The DeBorrow Governance Token (DEBO). Holders of this token have the ability to govern the protocol via the governor contract.</dd>
</dl>

<dl>
  <dt>Governor Alpha</dt>
  <dd>The administrator of the DeBorrow timelock contract. Holders of DEBO token may create and vote on proposals which will be queued into the DeBorrow timelock and then have effects on DeBorrow cToken and Copmtroller contracts. This contract may be replaced in the future with a beta version.</dd>
</dl>
...
Installation
------------
To run deborrow, pull the repository from GitHub and install its dependencies. You will need [yarn](https://yarnpkg.com/lang/en/docs/install/) or [npm](https://docs.npmjs.com/cli/install) installed.
...
You can read more about the scenario runner in the [Scenario Docs](https://github.com/deborrow-finance/deborrow-protocol/tree/master/scenario/SCENARIO.md) on steps for using the repl.

Testing
-------
Jest contract tests are defined under the [tests directory](https://github.com/deborrow-finance/deborrow-protocol/tree/master/tests). To run the tests run:
...
There are additional tests under the [spec/scenario](https://github.com/deborrow-finance/deborrow-protocol/tree/master/spec/scenario) folder. These are high-level integration tests based on the scenario runner depicted above. The aim of these tests is to be highly literate and have high coverage in the interaction of contracts.

Formal Verification Specs
-------------------------

The DeBorrow Protocol has a number of formal verification specifications, powered by [Certora](https://www.certora.com/). You can find details in the [spec/formal](https://github.com/deborrow-finance/deborrow-protocol/tree/master/spec/formal) folder. The Certora Verification Language (CVL) files included are specifications, which when with the Certora CLI tool, produce formal proofs (or counter-examples) that the code of a given contract exactly matches that specification.
=======
See the [Scenario Docs](https://github.com/deborrow-finance/money-market/tree/master/scenario/SCENARIO.md) on steps for using the repl.

Testing
-------
Contract tests are defined under the [tests directory](https://github.com/deborrow-finance/money-market/tree/master/tests). To run the tests run:
...
This command will start a saddle console conencted to Goerli testnet (see [Saddle README](https://github.com/deborrow-finance/saddle#cli)):
...
For any concerns with the protocol, open an issue or visit us on [Discord](https://deborrow.finance/discord) to discuss.

For security concerns, please email [security@deborrow.finance](mailto:security@deborrow.finance).

_© Copyright 2020, DeBorrow Labs_
